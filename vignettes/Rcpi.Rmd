...
Then compute the E-state fingerprints for all the molecules using
...
For the computed similarity matrix `simmat`, we will try to
do hierarchical clustering with it, then visualize the
clustering result:
...
The clustering result for these molecules is shown in Figure 5.
