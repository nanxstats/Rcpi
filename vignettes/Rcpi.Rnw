...
%\VignetteIndexEntry{Rcpi: Analysis Compound-Protein Interactions with R}
%\VignetteKeywords{R, Rcpi, protein sequence, amino acid, feature extraction}
...
\title{\pkg{Rcpi}: Analysis Compound-Protein Interactions with \proglang{R}}
\Plaintitle{Rcpi: Analysis Compound-Protein Interactions with R}

\Abstract{
  Abstract here.
}

\Keywords{\proglang{R}, Rcpi, protein sequence, amino acid, feature extraction}
\Plainkeywords{R, Rcpi, protein sequence, amino acid, feature extraction}
