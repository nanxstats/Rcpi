...
#' 
#' @return A length of \code{id} character list, each element containing the corresponding protein sequence(s) or file(s).
#' 
#' @keywords getProt
#'
#' @aliases getProt
...
#' 
#' @seealso See \code{\link{getDrug}} for retrieving drug molecules from five databases.
#' 
#' @export getProt
#' 
#' @examples
