...
#' CAS database only provides InChI data, so here we return the molecule in InChI format, 
#' users could convert them to SMILES format using Open Babel (\url{http://openbabel.org/})
