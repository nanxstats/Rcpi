...
#'                    'A', 'R', 'N', 'D', 'C', 'E', 'Q', 'G', 'H', 'I', 
#'                    'L', 'K', 'M', 'F', 'P', 'S', 'T', 'W', 'Y', 'V'}, 
#'                    and the columns should also be \emph{exactly} named 
#'                    like this.
...
#' 
#' @keywords extract PAAC extractProtPAAC Pseudo Amino Acid Composition
#'
...
extractProtPAAC = function (x, props = c('Hydrophobicity', 'Hydrophilicity', 
                                         'SideChainMass'), 
