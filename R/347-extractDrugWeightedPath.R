...
#' Descriptor that Calculates the Weighted Path (Molecular ID)
#' 
#' This descriptor calculates the weighted path (molecular ID) described by Randic,
#' characterizing molecular branching. 
...
#'         This function returns 5 columns named \code{WTPT.1}, \code{WTPT.2}, \code{WTPT.3},
#'         \code{WTPT.4}, \code{WTPT.5}:
#'         \itemize{
