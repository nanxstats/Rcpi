...
#' see \url{http://www.chemcomp.com/Journal_of_CCG/Features/descr.htm#KH} for details:
...
#'         This function returns 3 columns named \code{Kier1}, \code{Kier2} and \code{Kier3}:
#'         \itemize{
...
#' extractDrugKappaShapeIndices(mol)}
