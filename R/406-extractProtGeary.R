...
#'                    and the columns should also be \emph{exactly} 
#'                    named like this.
...
#' 
#' @keywords extract extractProtGeary Geary autocorrelation
#'
...
extractProtGeary = function (x, props = c('CIDH920105', 'BHAR880101',
    ...
    AAidx = read.csv(system.file('sysdata/AAidx.csv', package = 'Rcpi'), 
                     header = TRUE)
