...
#' PAM30, PAM40, PAM70, PAM120, and PAM250 matrices for the 20 amino acids to select.
#' 
#' @param x A character vector, as the input protein sequence.
#' @param submat Substitution matrix for the 20 amino acids. Should be one of
#'        \code{AABLOSUM45}, \code{AABLOSUM50}, \code{AABLOSUM62}, \code{AABLOSUM80}, \code{AABLOSUM100}, 
#'        \code{AAPAM30}, \code{AAPAM40}, \code{AAPAM70}, \code{AAPAM120}, \code{AAPAM250}.
...
extractPCMBLOSUM = function (x, submat = 'AABLOSUM62', k, lag, scale = TRUE, silent = TRUE) {
