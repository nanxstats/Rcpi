...
#' 
#' @param mol1 The first molecule. R character string object containing the molecule. See examples.
#' @param mol2 The second molecule. R character string object containing the molecule. See examples.
#' @param type The input molecule format, 'smile' or 'sdf'.
#' @param plot Logical. Should we plot the two molecules and their maximum common substructure?
